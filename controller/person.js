...
const Address = require('../models/Address'); // Address 모델 불러오기
...
const create = async (req, res) => {
    ...
    try {
        ...
        // 사용자 생성
        const newUser = await User.create({ userId, password, userName, userEmail, is_admin });
...
const update = async (req, res) => {
    ...
    try {
        ...
        // 사용자 정보 수정
        await user.update({ password, userName, userEmail, is_admin });
